...
import static com.winton.player.IPlayer.STATUS_BUFFER;
...
import static com.winton.player.IPlayer.STATUS_RELEASE;
 ...
 * @desc: 播放器状态
 */
@IntDef({STATUS_INIT,STATUS_STARTING, STATUS_PAUSE,STATUS_STOP,STATUS_ERROR,STATUS_RELEASE,STATUS_BUFFER})
